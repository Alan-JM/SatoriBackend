        ...
        return ResponseEntity.ok(
                bitacoraService.getAll().stream().map(b -> {
                    ...
                    return BitacoraFullDto.builder()
                            ...
                            .telefonoPerfilRegistro(i != null && i.getPerfilRegistro() != null ? i.getPerfilRegistro().getTelefono() : null)
                            .idAyudantes(i != null && i.getAyudantes() != null
                                    ? i.getAyudantes().stream().map(a -> a.getId()).toList()
                                    : List.of())
